...
export default function BackgroundImage() {
  ...
  return (
    <div
      ...
      className={`bg- absolute left-0 top-0 z-0  h-screen w-screen bg-[url('/img/background12.png')] bg-fixed bg-[position:center_40%] opacity-50  transition-all delay-100 duration-700 ${hoverStyles}`}
    ></div>
  )
}
