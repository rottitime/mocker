      ...
      <>
        ...
        <div>
          <input
            ...
            id={inputId}
            autoFocus
            className={`${className} w-full  rounded  bg-slate-100 px-3.5 py-2 text-black    transition-all duration-100 disabled:border-slate-200 disabled:bg-slate-50 disabled:text-slate-500 disabled:opacity-60 disabled:shadow-none  ${
              keyup ? 'keyup' : ''
            } ${
